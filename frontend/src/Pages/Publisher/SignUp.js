...
const SignUp = () => {
  ...
  const [mobileNumber, setMobileNumber] = useState("9265704645");
  ...
  const handleSubmit = async (event) => {
    try {
      ...
      const res = await axios.post("/student/sign-up", data);
      if (res.data.success) {
  ...
  return (
    <div className="sign-in__wrapper">
      ...
      <Form
        ...
        autoComplete="off"
      >
        <div className="h2 mb-2 text-center">Student's Sign Up</div>
        {/* ALert */}
        {show ? (
          <Alert
            className="mb-2"
